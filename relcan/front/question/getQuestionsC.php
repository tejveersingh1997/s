<?php
    ...
    if($Search != '')
    {
        $Qus = json_encode(array('Search' => $Searchquestions));
        goto a;
    }
    ...
    if($FilterEMH=="Easy")
    {
        $Qus = json_encode(array('Easy' => $Easyquestions));
    }
    else If ($FilterEMH== "Medium")
    {
        $Qus = json_encode(array('Medium' => $Mediumquestions));
    }
    else If ($FilterEMH== "Hard")
    {
        $Qus = json_encode(array('Hard' => $Hardquestions));
    }
    else
    {
    ...
    if($FilterTopic=="Lists")
    {
        if($FilterEMH=="Easy")
        {
            $Qus = json_encode(array('ListsE' => $ListsquestionsE));
            goto a;
        }
        else if($FilterEMH=="Medium")
        {
            $Qus = json_encode(array('ListsM' => $ListsquestionsM));
            goto a;
        }
        else if($FilterEMH=="Hard")
        {
            $Qus = json_encode(array('ListsH' => $ListsquestionsH));
            goto a;
        }
        else
        {
            $Qus = json_encode(array('Lists' => $Listsquestions));
        }
    }
    else if($FilterTopic=="Turtles")
    {
        if($FilterEMH=="Easy")
        {
            $Qus = json_encode(array('TurtlesE' => $TurtlesquestionsE));
            goto a;
        }
        else if($FilterEMH=="Medium")
        {
            $Qus = json_encode(array('TurtlesM' => $TurtlesquestionsM));
            goto a;
        }
        else if($FilterEMH=="Hard")
        {
            $Qus = json_encode(array('TurtlesH' => $TurtlesquestionsH));
            goto a;
        }
        else
        {
            $Qus = json_encode(array('Turtles' => $Turtlesquestions));
        }
    ...
    else if($FilterTopic=="If")
    {
        if($FilterEMH=="Easy")
        {
            $Qus = json_encode(array('IfE' => $IfquestionsE));
            goto a;
        }
        else if($FilterEMH=="Medium")
        {
            $Qus = json_encode(array('IfM' => $IfquestionsM));
            goto a;
        }
        else if($FilterEMH=="Hard")
        {
            $Qus = json_encode(array('IfH' => $IfquestionsH));
            goto a;
        }
        else
        {
        $Qus = json_encode(array('If' => $Ifquestions));        
        }
    }
    else if($FilterTopic=="For")
    {
        if($FilterEMH=="Easy")
        {
            $Qus = json_encode(array('ForE' => $ForquestionsE));
            goto a;
        }
        else if($FilterEMH=="Medium")
        {
            $Qus = json_encode(array('ForM' => $ForquestionsM));
            goto a;
        }
        else if($FilterEMH=="Hard")
        {
            $Qus = json_encode(array('ForH' => $ForquestionsH));
            goto a;
        }
        else
        {
            $Qus = json_encode(array('For' => $Forquestions));        
        }
    ...
    else if($FilterTopic=="Def")
    {
        if($FilterEMH=="Easy")
        {
            $Qus = json_encode(array('DefE' => $DefquestionsE));
            goto a;
        }
        else if($FilterEMH=="Medium")
        {
            $Qus = json_encode(array('DefM' => $DefquestionsM));
            goto a;
        }
        else if($FilterEMH=="Hard")
        {
            $Qus = json_encode(array('DefH' => $DefquestionsH));
            goto a;
        }
        else
        {
            $Qus = json_encode(array('Def' => $Defquestions));       
        }
    ...
    else if($FilterTopic=="While")
    {
        if($FilterEMH=="Easy")
        {
            $Qus = json_encode(array('WhileE' => $WhilequestionsE));
            goto a;
        }
        else if($FilterEMH=="Medium")
        {
            $Qus = json_encode(array('WhileM' => $WhilequestionsM));
            goto a;
        }
        else if($FilterEMH=="Hard")
        {
            $Qus = json_encode(array('WhileH' => $WhilequestionsH));
            goto a;
        }
        else
        {
            $Qus = json_encode(array('While' => $Whilequestions));      
        }
    ...
    else if($FilterTopic=="String")
    {
        if($FilterEMH=="Easy")
        {
            $Qus = json_encode(array('StringE' => $StringquestionsE));
            goto a;
        }
        else if($FilterEMH=="Medium")
        {
            $Qus = json_encode(array('StringM' => $StringquestionsM));
            goto a;
        }
        else if($FilterEMH=="Hard")
        {
            $Qus = json_encode(array('StringH' => $StringquestionsH));
            goto a;
        }
        else
        {
            $Qus = json_encode(array('String' => $Stringquestions));      
        }
    ...
    else if($FilterTopic=="Files")
    {
        if($FilterEMH=="Easy")
        {
            $Qus = json_encode(array('FilesE' => $FilesquestionsE));
            goto a;
        }
        else if($FilterEMH=="Medium")
        {
            $Qus = json_encode(array('FilesM' => $FilesquestionsM));
            goto a;
        }
        else if($FilterEMH=="Hard")
        {
            $Qus = json_encode(array('FilesH' => $FilesquestionsH));
            goto a;
        }
        else
        {
            $Qus = json_encode(array('Files' => $Filesquestions));      
        }
    ...
    else if($FilterTopic=="Dictionaries")
    {
        if($FilterEMH=="Easy")
        {
            $Qus = json_encode(array('DictionariesE' => $DictionariesquestionsE));
            goto a;
        }
        else if($FilterEMH=="Medium")
        {
            $Qus = json_encode(array('DictionariesM' => $DictionariesquestionsM));
            goto a;
        }
        else if($FilterEMH=="Hard")
        {
            $Qus = json_encode(array('DictionariesH' => $DictionariesquestionsH));
            goto a;
        }
        else
        {
            $Qus = json_encode(array('Dictionaries' => $Dictionariesquestions));      
        }
    ...
    else if($FilterTopic=="Namespaces")
    {
        if($FilterEMH=="Easy")
        {
            $Qus = json_encode(array('NamespacesE' => $NamespacesquestionsE));
            goto a;
        }
        else if($FilterEMH=="Medium")
        {
            $Qus = json_encode(array('NamespacesM' => $NamespacesquestionsM));
            goto a;
        }
        else if($FilterEMH=="Hard")
        {
            $Qus = json_encode(array('NamespacesH' => $NamespacesquestionsH));
            goto a;
        }
        else
        {
            $Qus = json_encode(array('Namespaces' => $Namespacesquestions));      
        }
    ...
    else if($FilterTopic=="Exceptions")
    {
        if($FilterEMH=="Easy")
        {
            $Qus = json_encode(array('ExceptionsE' => $ExceptionsquestionsE));
            goto a;
        }
        else if($FilterEMH=="Medium")
        {
            $Qus = json_encode(array('ExceptionsM' => $ExceptionsquestionsM));
            goto a;
        }
        else if($FilterEMH=="Hard")
        {
            $Qus = json_encode(array('ExceptionsH' => $ExceptionsquestionsH));
            goto a;
        }
        else
        {
            $Qus = json_encode(array('Exceptions' => $Exceptionsquestions));      
        }
    ...
    else if($FilterTopic=="Classes")
    {
        if($FilterEMH=="Easy")
        {
            $Qus = json_encode(array('ClassesE' => $ClassesquestionsE));
            goto a;
        }
        else if($FilterEMH=="Medium")
        {
            $Qus = json_encode(array('ClassesM' => $ClassesquestionsM));
            goto a;
        }
        else if($FilterEMH=="Hard")
        {
            $Qus = json_encode(array('ClassesH' => $ClassesquestionsH));
            goto a;
        }
        else
        {
            $Qus = json_encode(array('Classes' => $Classesquestions));     
        }
    ...
    $crl = curl_init();
    curl_setopt($crl, CURLOPT_URL, "https://web.njit.edu/~vpp29/relcan/front/teacher/create.php");
