...
afsconnect1-53 public_html >: nano iview_backend.php
afsconnect1-54 public_html >: nano iview_backend.php

  GNU nano 2.3.1                                             File: iview_backend.php                                                                                                 
...
$sql = "INSERT INTO `questionbank`(`QUESTION`, `DIFFICULTY`) VALUES ([$question],[$difficulty])";
$sql1 = "SELECT * FROM `questionbank` WHERE `QUESTION` = $question AND `DIFFICULTY` = $difficulty";
